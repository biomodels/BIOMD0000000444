# BIOMD0000000444: MODEL1112190007
...
`pip install git+https://github.com/biomodels/BIOMD0000000444.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/BIOMD0000000444.git@20140916`

## Usage

Importing the model package.

`import BIOMD0000000444 as model`
...
corresponds to model S2n that comprises negative feedback from MK-PP to MKK-PP
layer coupled to positive feedback from MK-PP to MKKK-PP layer, with the
...
and identified by:
[MODEL1112190007](http://identifiers.org/biomodels.db/MODEL1112190007) .
